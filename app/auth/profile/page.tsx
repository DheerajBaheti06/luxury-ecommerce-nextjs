...
// Tab component for the profile page
                ...
                <CardContent className="pt-0">
                  <nav className="space-y-1">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-2 py-2 rounded-lg text-neutral-400 hover:text-white hover:bg-neutral-800 text-xs md:text-sm"
                    >
            ...
            <div className="md:w-3/4">
                  ...
                  (isEditing ? (
                    <div className="flex gap-1">
                      <Button
                        ...
                        className="h-7 md:h-8 border-neutral-800 text-white hover:bg-neutral-800 text-xs px-2 md:px-3"
                      >
                      ...
                      <Button
                        onClick={handleSave}
                        disabled={isLoading}
                        className="h-7 md:h-8 bg-lime-400 text-black hover:bg-lime-400/90 text-xs px-2 md:px-3"
                      >
                        {isLoading ? (
                          <>
                            <div className="w-2 h-2 md:w-3 md:h-3 border-2 border-black border-t-transparent rounded-full animate-spin mr-1"></div>
                            Saving...
                          </>
                        ) : (
                          <>
              ...
              {activeTab === "profile" && (
                <div className="space-y-4 md:space-y-6">
                  ...
                  <Card className="bg-[#1a1a1a] border-neutral-800">
                    <CardHeader
                      className="pb-2 md:pb-3 cursor-pointer flex flex-row items-center justify-between"
                      ...
                      <CardContent className="space-y-3 md:space-y-4 pt-0">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                          <div className="space-y-1.5">
                            <Label className="text-neutral-400 text-xs md:text-sm">
                              Full Name
                            </Label>
                            {isEditing ? (
                              <Input
                        ...
                        <div className="grid grid-cols-3 gap-2 md:gap-4">
                            ...
                            <CardContent className="p-3 md:p-4">
                              <div className="flex items-center gap-2 md:gap-3">
                                <div className="bg-lime-400/10 p-1.5 md:p-2 rounded-lg">
                                  <ShoppingBag className="h-4 w-4 md:h-5 md:w-5 text-lime-400" />
                                </div>
                                <div>
                          ...
                          <Card className="bg-[#0f0f0f] border-neutral-800">
                            <CardContent className="p-3 md:p-4">
                              <div className="flex items-center gap-2 md:gap-3">
                                <div className="bg-lime-400/10 p-1.5 md:p-2 rounded-lg">
                                  <Mail className="h-4 w-4 md:h-5 md:w-5 text-lime-400" />
                                </div>
                                <div>
                                  <p className="text-base md:text-xl font-bold text-white">
                                    24/7
                  ...
                  <CardContent className="pt-4 md:pt-5">
                    <div className="space-y-2 md:space-y-3">
                      {mockOrders.map((order) => (
                        <div
                          key={order.id}
                          className="flex flex-col sm:flex-row sm:items-center justify-between p-2 md:p-3 bg-[#0f0f0f] rounded-lg border border-neutral-800"
                        >
                          <div>
                          ...
                          <div className="flex items-center gap-2 md:gap-3 mt-2 sm:mt-0">
                            ...
                            <Button
                              variant="outline"
                              size="sm"
                              className="h-6 md:h-7 border-neutral-800 text-white hover:bg-neutral-800 text-xs px-2"
                            >
                              Details
                            </Button>
                          </div>
